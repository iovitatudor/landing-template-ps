    ...
    <div className="instructions">
      <Container maxWidth={"xl"}>
        ...
        <div className="paragraph paragraph-1">
          Have ETH in your wallet to switch to Pero If you don’t have any ETH, you can buy directlyon metamask, transfer
        ...
        <div className="paragraph paragraph-3">
          ...
          your wallet. Paste the Pero token address into Uniswap, select Pero, and confirm. When Metamask prompts you
          for a wallet signature, sign.
        </div>
        <div className="heading heading-4">SWAP FOR $PERO</div>
        <div className="paragraph paragraph-2">
          Swap ETH for $PERO. In order to ensure a more efficient distribution of tokens among token holders and
